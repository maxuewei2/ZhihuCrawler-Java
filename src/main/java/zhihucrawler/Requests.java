...
class Requests {
    ...
    Requests(String cookieFileName, String userAgentFileName, int workers, int maxTryNum, int sleepMills, ConcurrentMap<String, String> errorUsers) throws IOException {
        cookieProvider = new CookieProvider(cookieFileName, userAgentFileName);
