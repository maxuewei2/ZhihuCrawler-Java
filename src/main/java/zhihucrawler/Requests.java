...
class Requests{
    ...
    Requests(String cookieFileName, int workers, int tryMax, ConcurrentMap<String,String> errorUsers,boolean verbose)throws IOException {
    ...
    void startThreads() {
        ...
        for (int i = 0; i < workers; i++) {
            requestThreads[i]=new Thread(new RequestJson(cookieProvider,proxyProvider,tryMax,requestQueue,requestQueue0,responseQueue,errorUsers,verbose));
